=== ProfileGrid - Profile, Groups and Communities ===
...
Beautiful profile building plugin for the rest of us…❤️️. Create communities, sign-up pages, paid memberships, restrict content and a lot more!
== Description ==

>✔ Version 2 launched with User Blogs, Private Messaging, Friends System, Notification and more!

Create communities, sign-up pages, paid memberships, restrict content, allow users to submit and share blogs, enable private messaging with a beautiful threaded interface and a lot more!

>For any issues, bugs, feature requests and general help, contact our awesome support team!
>[Create New Support Post](https://wordpress.org/support/plugin/profilegrid-user-profiles-groups-and-communities)
...
* Profile page showing single User Profile with blogs and conversations.
